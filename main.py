...
SENDER_EMAIL = os.getenv("SENDER_EMAIL", "supportdropzyy@gmail.com").strip()
SENDER_PASSWORD = os.getenv("SENDER_PASSWORD", "reoovuigihzuepcn").replace(" ", "").replace('"', '').replace("'", "").strip()
...
def send_email_otp(to_email: str, otp_code: str) -> bool:
    ...
    print(f"\n==================================================")
    print(f" [DROPZYY SMTP EMAIL OTP] Sender: {SENDER_EMAIL} -> Target: {to_email}")
