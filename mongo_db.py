...
DEFAULT_MONGODB_URI = "mongodb+srv://yashpatil7224_db_user:Y4hZCo94P6RzrLvl@cluster0.disbnkj.mongodb.net/freshkart?retryWrites=true&w=majority&tlsAllowInvalidCertificates=true"
DIRECT_MONGODB_URI = "mongodb://yashpatil7224_db_user:Y4hZCo94P6RzrLvl@ac-hdqgbpt-shard-00-00.disbnkj.mongodb.net:27017,ac-hdqgbpt-shard-00-01.disbnkj.mongodb.net:27017,ac-hdqgbpt-shard-00-02.disbnkj.mongodb.net:27017/freshkart?ssl=true&replicaSet=atlas-fwvyil-shard-0&authSource=admin&retryWrites=true&w=majority&tlsAllowInvalidCertificates=true"

raw_uri = os.getenv("MONGODB_URI", "").strip()
if raw_uri.startswith("mongodb"):
    MONGODB_URI = raw_uri
else:
...
def get_mongo_client() -> Optional[MongoClient]:
    ...
    attempts = [
        {"uri": MONGODB_URI, "kwargs": {"tlsAllowInvalidCertificates": True, "serverSelectionTimeoutMS": 5000}},
        {"uri": DIRECT_MONGODB_URI, "kwargs": {"tlsAllowInvalidCertificates": True, "serverSelectionTimeoutMS": 5000}},
        {"uri": MONGODB_URI, "kwargs": {"serverSelectionTimeoutMS": 5000}}
    ]
    if ca_file:
        attempts.insert(1, {"uri": MONGODB_URI, "kwargs": {"tlsCAFile": ca_file, "serverSelectionTimeoutMS": 5000}})
